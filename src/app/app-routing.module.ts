...
const routes: Routes = [
  ...
  /*  {
    ...
    children: [
      {
        path: '',
        loadChildren: () => import('./pages/products/bmaas/bmaas.module').then(m => m.BmaasPageModule),
        canActivate: [HomeGuard]
      },
      {
        path: ':zone/:id',
        loadChildren: () => import('./pages/products/bmaas/details/details.module').then(m => m.DetailsPageModule),
        canActivate: [HomeGuard]
      },
    ]
  },*/
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        loadChildren: () => import('./pages/products/buckets/buckets.module').then(m => m.ObjectsPageModule),
      },
      {
        path: ':region/:bucket',
        children: [
